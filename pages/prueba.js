...
export default function Home() {
  ...
  const handleEditText = () => {
    if (newText && iTextRef.current.text !== newText) {
      const newList = [...list]
  ...
  // const handleEditText = () => {
  //   console.log(canvasInstance?._objects);
  //   if (newText) {
  //     iTextRef.current.set("text", newText)
  //     canvasInstance.renderAll()
  //   }
  //   setList(canvasInstance?._objects)
  // }
  ...
  return (
    <div style={{ backgroundColor: 'white', height: '100vh', padding: 24 }}>
      <br />
          ...
          <Grid item>
            <Stack spacing={1} direction='row'>
              ...
              <TextField
                ...
                maxRows={3}
              />
              <Button disabled={!newText} onClick={createIText}>Add text</Button>
              <Button disabled={!(newText && list.length)} onClick={handleEditText} >Editar texto</Button>
